...
import { ArrowRight, Shield, Cpu, Globe, Zap, Users, Code2, ChevronDown, LogOut, User } from 'lucide-react';
            ...
            {user ? (
              <div className="flex flex-col items-center gap-4 mb-2">
                <div className="flex items-center gap-3 px-5 py-3 border border-blue-500/30 bg-blue-950/10 rounded-sm">
                  ...
                  <button onClick={signOut} className="ml-2 p-2 text-white/40 hover:text-red-400 transition-colors" title="Sign out">
